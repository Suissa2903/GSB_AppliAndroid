...
public class FraisAuForfait<JJ> extends MainActivity {
    ...
    public void save_Data(View view){
        if (Quantite.getText().toString().trim().length() == 0  || Type.getSelectedItemPosition()==0 ) { // si rien dans Quantite
            Toast.makeText(FraisAuForfait.this,"Erreur, aucune quantitee saisie" ,Toast.LENGTH_LONG).show();
